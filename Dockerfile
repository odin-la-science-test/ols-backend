...
ENTRYPOINT ["/bin/sh", "-c", "echo '--- ENV VARS START ---'; env | grep -E 'SPRING_|JWT_' || echo 'No variables found'; echo '--- ENV VARS END ---'; java -Xmx384m -jar app.jar --server.port=7860 --spring.profiles.active=prod"]
