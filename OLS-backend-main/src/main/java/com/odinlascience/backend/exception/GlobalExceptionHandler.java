...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleGeneric(Exception ex, HttpServletRequest request) {
        ...
        @ExceptionHandler(PreferencesConflictException.class)
        public ResponseEntity<UserPreferencesDTO> handlePreferencesConflict(PreferencesConflictException ex) {
            return ResponseEntity.status(HttpStatus.CONFLICT).body(ex.getServerPreferences());
        }

        @ExceptionHandler(AuthProviderConflictException.class)
        public ResponseEntity<ErrorResponseDTO> handleAuthProviderConflict(AuthProviderConflictException ex, HttpServletRequest request) {
            ErrorResponseDTO error = ErrorResponseDTO.builder()
                    .status(HttpStatus.CONFLICT.value())
                    .error("Auth Provider Conflict")
                    .message(ex.getMessage())
                    .path(request.getRequestURI())
                    .timestamp(LocalDateTime.now())
                    .build();
        ...
        public ResponseEntity<com.odinlascience.backend.auth.dto.SessionLimitResponse> handleSessionLimit(
                SessionLimitExceededException ex) {
            com.odinlascience.backend.auth.dto.SessionLimitResponse response =
                    com.odinlascience.backend.auth.dto.SessionLimitResponse.builder()
                            .message(ex.getMessage())
                            .activeSessions(ex.getActiveSessions())
                            .maxSessions(ex.getMaxSessions())
                            .build();
