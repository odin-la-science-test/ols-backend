...
class NotificationEventListenerTest {
    ...
    void onModuleAccessGranted_sendsNotification() {
        var event = new ModuleAccessGrantedEvent("user@test.com", "mycology");
    ...
    void onModuleAccessGranted_doesNotPropagateException() {
        ...
        when(notificationService.send(anyString(), any(), anyString(), anyString(), nullable(String.class), anyString()))
                .thenThrow(new RuntimeException("DB error"));

        listener.onModuleAccessGranted(event);

        verify(notificationService).send(anyString(), any(), anyString(), anyString(), nullable(String.class), anyString());
    }
}
