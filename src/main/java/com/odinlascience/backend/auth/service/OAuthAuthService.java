...
public class OAuthAuthService {
    ...
    @Transactional
    public AuthResponse authenticateWithGoogle(String code, String deviceInfo, String ipAddress) {
    ...
    @Transactional
    public AuthResponse authenticateWithCas(String ticket, String serviceUrl, String deviceInfo, String ipAddress) {
    ...
    private User findOrCreateOAuthUser(String email, String externalId, String firstName, String lastName,
        ...
        if (existingUser.isPresent()) {
            ...
            // Mettre a jour l'externalId si necessaire
