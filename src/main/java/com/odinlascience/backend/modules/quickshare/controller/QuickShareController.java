...
public class QuickShareController {
    ...
    public ResponseEntity<Resource> downloadFile(
        ...
        Resource resource = service.downloadFile(shareCode, fileId);
        SharedFile sharedFile = service.getSharedFile(fileId);
    ...
    public void downloadAll(
        ...
        String zipName = service.getZipFilename(shareCode);
        response.setContentType("application/zip");
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + zipName + "\"");
        service.writeZip(shareCode, response.getOutputStream());
