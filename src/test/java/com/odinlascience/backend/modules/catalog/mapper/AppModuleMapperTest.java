...
class AppModuleMapperTest {
    ...
    void toDTO_FullMapping_MapsFieldsAndDefaults() {
        ...
        assertEquals(m.getTitle(), dto.getTitle());
        assertEquals(m.getIcon(), dto.getIcon());
        assertEquals(m.getDescription(), dto.getDescription());
        assertEquals(m.getRoutePath(), dto.getRoutePath());
